...
@interface AVSuperView () <UICollectionViewDelegate, UICollectionViewDataSource>
@property (nonatomic, assign) int selectedIndex;
@property (nonatomic, strong) UICollectionView* collectionView;
@property (nonatomic, strong) AVLayout* avLayout;
@end
...
- (AVSuperView*)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        self.avLayout = avLayout;
        avLayout.interitemSpacing = 20;
        avLayout.itemSize = CGSizeMake(50,50);
        UICollectionView* collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(20, 50, [[UIScreen mainScreen] bounds].size.width - 40, 50) collectionViewLayout:avLayout];
...
- (void)setSelectedIndex:(int)selectedIndex
{
    ...
    self.avLayout.selectedIndex = selectedIndex;
}
